// 📁 src/routes/notificacaoRoute.js — PREMIUM (date-only safe, robusto, consistente)
...
if (typeof query !== "function") {
  console.error("[notificacaoRoute] DB inválido:", Object.keys(dbMod || {}));
  throw new Error("DB inválido em notificacaoRoute.js (query ausente)");
}
...
router.get(
  ...
  handle(async (req, res) => {
    ...
    try {
      ...
      const notificacao = (result.rows || []).map((n) => ({
        id: n.id,
        mensagem: n.mensagem,
        lida: !!n.lida,
