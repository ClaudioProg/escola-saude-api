// ✅ src/routes/presencasRoute.js — PREMIUM (robusto, seguro, sem duplicações, compatível)
...
const presencasCtrl = require("../controllers/presencasController");
...
for (const fn of required) {
  if (typeof ctrl?.[fn] !== "function") {
    console.error("[presencasRoute] presencasController inválido:", fn, presencasCtrl);
    throw new Error(`presencasController inválido (função ausente: ${fn})`);
  }
}
