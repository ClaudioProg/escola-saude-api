// 📁 src/routes/loockupsPublicRoutes.js — PREMIUM (leve, cache-aware, resiliente)
...
for (const fn of requiredFns) {
  if (typeof ctrl?.[fn] !== "function") {
    console.error("[loockupsPublicRoutes] Controller inválido:", fn, lookupsCtrl);
...
router.get(
  "/cargos",
  routeTag("loockupsPublicRoutes:GET /cargos"),
  withLookupCache,
...
router.get(
  "/unidades",
  routeTag("loockupsPublicRoutes:GET /unidades"),
  withLookupCache,
...
router.get(
  "/generos",
  routeTag("loockupsPublicRoutes:GET /generos"),
  withLookupCache,
...
router.get(
  "/orientacoes-sexuais",
  routeTag("loockupsPublicRoutes:GET /orientacoes-sexuais"),
  withLookupCache,
  handle(ctrl.listOrientacoesSexuais)
);

// 🎨 Cores / Raças
router.get(
  "/cores-racas",
  routeTag("loockupsPublicRoutes:GET /cores-racas"),
  withLookupCache,
...
router.get(
  "/escolaridades",
  routeTag("loockupsPublicRoutes:GET /escolaridades"),
  withLookupCache,
...
router.get(
  "/deficiencias",
  routeTag("loockupsPublicRoutes:GET /deficiencias"),
  withLookupCache,
